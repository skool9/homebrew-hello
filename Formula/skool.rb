class Skool < Formula
  ...
  "
      def skoolers = {'ANBR' => 'Antoine Bres (ANBR)', 'JORO' => 'Joseph Robert (JORO)', 'MARL' => 'Marta Laranaga (MARL)', 'MIWE' => 'Michael Wegerich (MIWE)', 'SEBA' => 'Sébastien Bartoli (SEBA)', 'STAN' => 'Stanislas Chable'}
